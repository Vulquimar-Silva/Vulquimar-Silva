...
### Algumas (Linguagens de programação - Bibliotecas - Frameworks - Gerenciadores de pacotes - sistema de controle de versão) que tenho trabalho e tenho um pouco de conhecimento
